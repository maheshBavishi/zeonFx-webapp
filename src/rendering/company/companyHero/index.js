...
const Commodities = '/assets/video/company.mp4';
                ...
                <div className='container'>
                    ...
                    >
                        ...
                        <motion.div variants={fadeUp}>
                            <ButtonText text="Company" />
                        </motion.div>

                        {/* Heading */}
                        <motion.h1 variants={fadeUp}>
                            A better trading <br />
                            experience, <span> built </span> for you.
                        </motion.h1>

                        {/* Description */}
                        <motion.p variants={fadeUpSlow}>
                            ZeonFX is a next-generation multi-asset broker for traders who want more speed, more control,
                            and more opportunity, without the friction of legacy brokers.
                        </motion.p>
