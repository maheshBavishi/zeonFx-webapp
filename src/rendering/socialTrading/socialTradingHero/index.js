...
const Commodities = '/assets/video/SocialTrading.mp4';
...
export default function SocialTradingHero() {
  return (
        ...
        <div className='container'>
          ...
          >
            ...
            <motion.p variants={fadeUpSlow}>
              Copy top-performing traders in real time. You stay in control of your risk settings at all times.
            </motion.p>
