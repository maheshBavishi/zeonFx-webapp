        ...
        <div className={styles.marketOverview}>
            <div className='container'>
                ...
                <div className={styles.firstgrid}>
                    <Link href="/indices" style={{ textDecoration: 'none', display: 'block' }}>
                        <motion.div
                ...
                <div className={styles.secgrid}>
                    <Link href="/metals" style={{ textDecoration: 'none', display: 'block' }}>
                        <motion.div
                    ...
                    <Link href="/commodities" style={{ textDecoration: 'none', display: 'block' }}>
                        <motion.div
                            className={styles.box}
                            initial={{ opacity: 0, y: 30 }}
                            whileInView={{ opacity: 1, y: 0 }}
                ...
                <div className={styles.lastgrid}>
                    <Link href="/crypto" style={{ textDecoration: 'none', display: 'block' }}>
                        <motion.div
                    ...
                    <Link href="/stocks" style={{ textDecoration: 'none', display: 'block' }}>
                        <motion.div
